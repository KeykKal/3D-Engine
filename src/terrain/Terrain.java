...
public class Terrain {
	...
	public Terrain(int gridX, int gridZ, Loader loader, TerrainTexturePack texturePack,
			TerrainTexture blendMap, String heightMap, boolean useProceduralTerrain) {
		this.texturePack = texturePack;
		this.blendMap = blendMap;
		this.x = gridX * SIZE;
		this.z = gridZ * SIZE;
		generator = new HeightsGenerator(gridX, gridZ, VERTEX_COUNT, SEED);
		if(useProceduralTerrain) this.model = generateProceduralTerrain(loader);
	...
	public Terrain(int gridX, int gridZ, Loader loader, TerrainTexturePack texturePack,
			TerrainTexture blendMap, boolean useProceduralTerrain) {
		this.texturePack = texturePack;
		this.blendMap = blendMap;
		this.x = gridX * SIZE;
		this.z = gridZ * SIZE;
		generator = new HeightsGenerator(gridX, gridZ, VERTEX_COUNT, SEED);
		if(useProceduralTerrain) this.model = generateProceduralTerrain(loader);
		else this.model = generateFlatTerrain(loader);
	}
	...
	private RawModel generateProceduralTerrain(Loader loader){
