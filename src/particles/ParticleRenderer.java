...
public class ParticleRenderer {
	...
	protected ParticleRenderer(Loader loader, Matrix4f projectionMatrix){
		...
		loader.addInstanceAttribut(quad.getVaoID(), vbo, 1, 4, INSTANCE_DATA_LENGTH, 0);
		loader.addInstanceAttribut(quad.getVaoID(), vbo, 2, 4, INSTANCE_DATA_LENGTH, 4);
		loader.addInstanceAttribut(quad.getVaoID(), vbo, 3, 4, INSTANCE_DATA_LENGTH, 8);
		loader.addInstanceAttribut(quad.getVaoID(), vbo, 4, 4, INSTANCE_DATA_LENGTH, 12);
		loader.addInstanceAttribut(quad.getVaoID(), vbo, 5, 4, INSTANCE_DATA_LENGTH, 16);
		loader.addInstanceAttribut(quad.getVaoID(), vbo, 6, 1, INSTANCE_DATA_LENGTH, 20);
